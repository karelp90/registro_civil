 ...
 */
@Entity
@DiscriminatorValue("DIVORCIO")
@Table(name = "divorcio")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Divorcio.findAll", query = "SELECT d FROM Divorcio d")})
public class Divorcio extends Solicitud {
    ...
    @DateTimeFormat(pattern = "dd/MM/yyyy")
    @Column(name = "fecha_divorcio")
    @Temporal(TemporalType.DATE)
    private Date fechaDivorcio;
    ...
    public Date getFechaDivorcio() {
        return fechaDivorcio;
    }

    public void setFechaDivorcio(Date fechaDivorcio) {
    ...
    public String toString() {
        return "cu.registro_civil.web.model.Divorcio[ idSolicitud=" + super.getId() + " ]";
    }
