 ...
 */
@Entity
@DiscriminatorValue("VIUDEZ")
@Table(name = "viudez")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Viudez.findAll", query = "SELECT v FROM Viudez v")})
public class Viudez extends Solicitud {
    ...
    public String toString() {
        return "cu.registro_civil.web.model.Viudez[ idSolicitud=" + super.getId() + " ]";
    }
