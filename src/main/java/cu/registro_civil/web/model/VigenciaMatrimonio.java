 ...
 */
@Entity
@DiscriminatorValue("VIGENCIA_MATRIMONIO")
@Table(name = "vigencia_matrimonio")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "VigenciaMatrimonio.findAll", query = "SELECT v FROM VigenciaMatrimonio v")})
public class VigenciaMatrimonio extends Solicitud {
    ...
    public String toString() {
        return "cu.registro_civil.web.model.VigenciaMatrimonio[ idSolicitud=" + super.getId() + " ]";
    }
