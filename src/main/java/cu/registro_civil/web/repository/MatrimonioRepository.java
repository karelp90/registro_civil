...
@RepositoryRestResource(collectionResourceRel = "listado", path = "matrimonio")
public interface MatrimonioRepository extends PagingAndSortingRepository<Matrimonio, Integer>{
