...
@RepositoryRestResource(collectionResourceRel = "listado", path = "nacimiento")
public interface NacimientoRepository extends PagingAndSortingRepository<Nacimiento, Integer>{
